...
public class FieldMeasurements {
    ...
    /*
    // The red community X points need to be ivnerted.
    // public static final double RED_COMMUNITY_NORTHERN_SECTION_SOUTHWEST_CORNER_X_INCHES = HALF_FIELD_WIDTH_INCHES_TIMES_2 - DISTANCE_FROM_WALL_TO_COMMUNITY_INCHES;
    public static final double RED_COMMUNITY_NORTHERN_SECTION_SOUTHWEST_CORNER_X_INCHES = getInvertedWidthInches(DISTANCE_FROM_WALL_TO_COMMUNITY_INCHES);
    public static final double RED_COMMUNITY_NORTHERN_SECTION_SOUTHWEST_CORNER_Y_INCHES = COMMUNITY_SOUTHERN_SECTION_HEIGHT_INCHES + COMMUNITY_COOP_SECTION_HEIGHT_INCHES;
    public static final double RED_COMMUNITY_COOP_SECTION_SOUTHWEST_CORNER_X_INCHES = HALF_FIELD_WIDTH_TIMES_2_INCHES - DISTANCE_FROM_WALL_TO_COMMUNITY_INCHES;
    public static final double RED_COMMUNITY_COOP_SECTION_SOUTHWEST_CORNER_Y_INCHES = COMMUNITY_SOUTHERN_SECTION_HEIGHT_INCHES;
    public static final double RED_COMMUNITY_COOP_SOUTHERN_SOUTHWEST_CORNER_X_INCHES = HALF_FIELD_WIDTH_TIMES_2_INCHES - DISTANCE_FROM_WALL_TO_COMMUNITY_INCHES;
    public static final double RED_COMMUNITY_COOP_SOUTHERN_SOUTHWEST_CORNER_Y_INCHES = 0;
*/
    ...
    /*
    public static final double RED_COMMUNITY_NORTHERN_SECTION_SOUTHWEST_CORNER_X_METERS = RED_COMMUNITY_NORTHERN_SECTION_SOUTHWEST_CORNER_X_INCHES * INCHES_TO_METERS_CONVERSION;
    public static final double RED_COMMUNITY_NORTHERN_SECTION_SOUTHWEST_CORNER_Y_METERS = RED_COMMUNITY_NORTHERN_SECTION_SOUTHWEST_CORNER_Y_INCHES * INCHES_TO_METERS_CONVERSION;
    public static final double RED_COMMUNITY_COOP_SECTION_SOUTHWEST_CORNER_X_METERS = RED_COMMUNITY_COOP_SECTION_SOUTHWEST_CORNER_X_INCHES * INCHES_TO_METERS_CONVERSION;
    public static final double RED_COMMUNITY_COOP_SECTION_SOUTHWEST_CORNER_Y_METERS = RED_COMMUNITY_COOP_SECTION_SOUTHWEST_CORNER_Y_INCHES * INCHES_TO_METERS_CONVERSION;
    public static final double RED_COMMUNITY_COOP_SOUTHERN_SOUTHWEST_CORNER_X_METERS = RED_COMMUNITY_COOP_SOUTHERN_SOUTHWEST_CORNER_X_INCHES * INCHES_TO_METERS_CONVERSION;
    public static final double RED_COMMUNITY_COOP_SOUTHERN_SOUTHWEST_CORNER_Y_METERS = RED_COMMUNITY_COOP_SOUTHERN_SOUTHWEST_CORNER_Y_INCHES * INCHES_TO_METERS_CONVERSION;
*/
