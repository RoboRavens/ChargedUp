...
public class Robot extends TimedRobot {
  ...
  private void configureButtonBindings() {
    ...
    OP_PAD_BUTTONS.getButton(ButtonCode.ROTATE_ARM_FORWARD)
      ...
      .whileTrue(armDefaultCommand.andThen(new RepeatCommand(new InstantCommand(() -> ARM_SUBSYSTEM.increaseRotationTargetManually()))));

    OP_PAD_BUTTONS.getButton(ButtonCode.ROTATE_ARM_BACKWARD)
    .and(OP_PAD_SWITCHES.getButton(ButtonCode.ARM_ROTATION_MANUAL_OVERRIDE).negate())
    // .and(OP_PAD_SWITCHES.getButton(ButtonCode.IGNORE_ROTATION_LIMITS))
    .whileTrue(armDefaultCommand.andThen(new RepeatCommand(new InstantCommand(() -> ARM_SUBSYSTEM.decreaseRotationTargetManually()))));
    ...
    // .and(OP_PAD_SWITCHES.getButton(ButtonCode.IGNORE_EXTENSION_LIMITS))
      .whileTrue(armDefaultCommand.andThen(new RepeatCommand(new InstantCommand(() -> ARM_SUBSYSTEM.increaseExtensionTargetManually()))));

    OP_PAD_BUTTONS.getButton(ButtonCode.RETRACT_ARM)
      .and(OP_PAD_SWITCHES.getButton(ButtonCode.ARM_EXTENSION_MANUAL_OVERRIDE).negate())
      // .and(OP_PAD_SWITCHES.getButton(ButtonCode.IGNORE_EXTENSION_LIMITS))
      .whileTrue(armDefaultCommand.andThen(new RepeatCommand(new InstantCommand(() -> ARM_SUBSYSTEM.decreaseExtensionTargetManually()))));
